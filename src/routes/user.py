...
UserBlueprint.route("/users/<uuid:id>/change-password",
                    methods=['POST'])(jwt_required(UserResource.user_change_password))
UserBlueprint.route("/users/<uuid:id>/create-auth-pin",
                    methods=['POST'])(jwt_required(UserResource.user_create_auth_pin))
UserBlueprint.route("/users/<uuid:id>/change-auth-pin",
                    methods=['POST'])(jwt_required(UserResource.user_change_auth_pin))
UserBlueprint.route("/users/<uuid:id>/create-transaction-pin",
                    methods=['POST'])(jwt_required(UserResource.user_create_transaction_pin))
UserBlueprint.route("/users/<uuid:id>/change-transaction-pin",
