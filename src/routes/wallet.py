...
WalletBlueprint.route("/ngn-wallets", methods=['POST'])(WalletResource.ngn_create)
WalletBlueprint.route("/wallets", methods=['POST'])(jwt_required(WalletResource.other_wallet))
