...
WalletBlueprint.route("/inapp-wallets", methods=['POST'])(WalletResource.create)
WalletBlueprint.route("/wallets", methods=['POST'])(jwt_required(WalletResource.create_public))
