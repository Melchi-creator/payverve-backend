    ...
    def create(target_amount, duration, user_id):
        ...
        try:
            ...
            NotificationResource.store_nofication(
                ...
                body=f"₦{float(target_amount):,.2f} has been saved in your fixed deposit -> {title}",
                user_id=user_id,
            )
            ...
            data = [
                {
                    ...
                    'end_date': fd.end_date.strftime("%d %b %Y, %I:%M %p"),
                    'start_date': fd.start_date.strftime("%d %b %Y, %I:%M %p"),
                    'is_deleted': fd.is_deleted,
                    'deleted_at': fd.deleted_at.strftime("%d %b %Y, %I:%M %p") if fd.updated_at else None,
                    'created_at': fd.created_at.strftime("%d %b %Y, %I:%M %p"),
                    'updated_at': fd.updated_at.strftime("%d %b %Y, %I:%M %p") if fd.updated_at else None,
                    'user_id': fd.user_id,
    ...
    def fetch(id=None):
        ...
        try:
            ...
            data = {
                ...
                'end_date': fixed_deposit.end_date.strftime("%d %b %Y, %I:%M %p"),
                'start_date': fixed_deposit.start_date.strftime("%d %b %Y, %I:%M %p"),
                'is_deleted': fixed_deposit.is_deleted,
                'deleted_at': fixed_deposit.deleted_at.strftime("%d %b %Y, %I:%M %p") if fixed_deposit.updated_at else None,
                'created_at': fixed_deposit.created_at.strftime("%d %b %Y, %I:%M %p"),
                'updated_at': fixed_deposit.updated_at.strftime("%d %b %Y, %I:%M %p") if fixed_deposit.updated_at else None,
    ...
    def withdraw_fixed_deposit(id=None, user_id=None):
        ...
        try:
            ...
            NotificationResource.store_nofication(
                ...
                body=f"₦{float(decrypt_balance):,.2f} has been withdrawn from your fixed deposit -> {fixed_deposits.title}",
                user_id=user_id,
            )
