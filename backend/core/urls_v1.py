...
from .views import (WalletListCreate, TransferListCreate,
...
urlpatterns = [
    ...
    path('wallet-to-wallet/<int:pk>/<int:receiver_wallet_id>/', WalletToWalletTransferView.as_view(),
         name='wallet-to-wallet-transfer'),
    path('wallet-to-bank/<int:pk>/', WalletToBankTransferView.as_view(), name='wallet-to-bank-transfer'),
    # path('wallet-to-wallet/<int:sender_wallet_id>/<int:receiver_wallet_id>/<decimal:amount>/', initiate_wallet_to_wallet_transfer, name='wallet-to-wallet-transfer'),
    # path('wallet-to-bank/<int:sender_wallet_id>/<decimal:amount>/<str:bank_account_number>/<str:bank_code>/', initiate_wallet_to_bank_transfer, name='wallet-to-bank-transfer'),
    path('exchange-rate/<str:base_currency>/<str:target_currency>/', get_currency_exchange_rate,
